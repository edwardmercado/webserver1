...
<html>
<head>
<link rel = "stylesheet" rev = "stylesheet" href = "editProfileForm.css">
<script>
...
<div class ="dialog">
	...
	$ctr = 0;
	$id = $_GET['id'];
	$sqlCmb = mysql_query("SELECT * from tbl_admin where id = '$id'");
	...
	?>
	<form id="addProducts" method = "POST" enctype="multipart/form-data" action = "editProfile.php?id=<?php echo $id ?>">
	<div class = "firstname">
	First Name:<br>
